...
namespace YrUtility.Excel
{
    public class ExcelHelper
    {
        ...
        public ExcelHelper(Stream stream, String exName)
        {
            _IWorkbook = CreateWorkbook(stream, exName);
        }
        ...
        public ExcelHelper(string fileName)
        {
            ...
            {
                _IWorkbook = CreateWorkbook(fileStream, FileHelper.GetExName(fileName));
            }
        }
                    ...
                    if (cell != null)
                    {
                        switch (cell.CellType)
                        {
                            ...
                            case CellType.Boolean:
                                ...
                                break;
                            default: dataRow[r] = cell.StringCellValue;
                                break;
                        }
                    }
                }
